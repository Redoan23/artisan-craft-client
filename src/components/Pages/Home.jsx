...
const Home = () => {
    ...
    return (
        <div className='bg-white dark:bg-gray-700 scroll-smooth dark:text-white dark:text-opacity-70'>
            ...
            <div className='bg-white  dark:bg-gray-900 '>
                ...
                <div className=' mt-20 lg:mt-24'>
                    <div className='dark:bg-gray-700 dark:bg-gradient-to-r dark:from-gray-900 dark:to-gray-900 dark:text-white dark:text-opacity-85 bg-gradient-to-tr from-gray-200 to-white'>
                        <h3 className=' text-center dark:text-white dark:text-opacity-85 font-bold text-3xl lg:text-5xl text-red-500 pt-16'>CRAFTED ITEMS</h3>
                ...
                <div id='category' className=' mt-24 mb-24 dark:mb-0 dark:pb-24 '>
                    <h1 className=' md:text-3xl text-2xl lg:text-5xl font-bold dark:text-white dark:text-opacity-80 text-red-500 text-center'>ART & CRAFTS CATEGORY</h1>
            ...
            <div className=' my-28'>
                <h1 className=' text-center font-bold text-red-500 md:text-3xl text-2xl lg:text-5xl pb-5'>OUR FAKE SPONSORS</h1>
                <Marquee  >
